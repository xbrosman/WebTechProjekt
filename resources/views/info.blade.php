    ...
    <div class="container">
        ...
        <div class="container">
            <ul class="list-group text-dark">
                ...
                <li class="list-group-item list-group-item-dark"><strong>{{ __('Logs exported to CSV + sending mail') }}</strong>:Alex Teplanský <strong>{{ __('Not completed') }}</strong></li>
                <li class="list-group-item list-group-item-dark"><strong>{{ __('API description export to PDF') }}</strong>: Dávid Baranec, Alex Teplanský <strong>{{ __('Not completed') }}</strong></li>
                ...
                <li class="list-group-item list-group-item-dark"><strong>{{ __('Finalization') }}</strong>: <strong>{{ __('Not completed') }}</strong></li>
